...
public class Parameters {
  ...
  //-----------------------//
    ...
    public static final String teamAMainBotBrainClassName = "algorithms.MainBotBrain"; //class given by name; is supposed to extends robotsimulator.Brain
    ...
    public static final String teamASecondaryBotBrainClassName = "algorithms.SecondaryBotBrain"; //class given by name; is supposed to extends robotsimulator.Brain
